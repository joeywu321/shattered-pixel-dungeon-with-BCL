...
import com.shatteredpixel.shatteredpixeldungeon.windows.WndStore;
...
public class Toolbar extends Component {
	...
	protected void createChildren() {
		...
		add(store = new Tool(64, 0, 22, 24) {

			@Override
			protected void onClick() {
				GameScene.show(new WndStore(Dungeon.hero.belongings.backpack, null, WndStore.Mode.ALL, null));
			}
	...
	protected void layout() {
		...
		store.setPos(right - store.width(), 15);
		right = width;
