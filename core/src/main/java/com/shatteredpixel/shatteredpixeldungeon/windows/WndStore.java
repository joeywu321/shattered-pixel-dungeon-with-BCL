...
public class WndStore extends WndTabbed {
	...
	public WndStore(Bag bag, Listener listener, Mode mode, String title ) {
	...
	public static WndStore lastBag(Listener listener, Mode mode, String title ) {

		if (mode == lastMode && lastBag != null &&
			Dungeon.hero.belongings.backpack.contains( lastBag )) {

			return new WndStore( lastBag, listener, mode, title );

		} else {

			return new WndStore( Dungeon.hero.belongings.backpack, listener, mode, title );

		}
	}

	public static WndStore getBag(Class<? extends Bag> bagClass, Listener listener, Mode mode, String title ) {
		Bag bag = Dungeon.hero.belongings.getItem( bagClass );
		return bag != null ?
				new WndStore( bag, listener, mode, title ) :
	...
	private class ItemButton extends ItemSlot {
		...
		protected void onClick() {
			if (!lastBag.contains(item) && !item.isEquipped(Dungeon.hero)){
				...
				GameScene.show(new WndItem( WndStore.this, item ) );
